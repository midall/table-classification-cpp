...
int main() {
	...
	string errors[] = {
			...
			"DISTANCE CHOICE IS WRONG. MUST BE EITHER 'euclidean' OR 'manhattan'"
			...
			try{
				...
				do {
					...
					switch(choice) {
						...
						case 1:
						cout 	<< "Starting Tables Classification (euclidean)... \n";
						dl = cls.classificationTable("euclidean");
						cout 	<< "End of Tables Classification. \n";
						break;
						
						//CLASSIFICATION MANHATTAN
						case 2:
						cout 	<< "Starting Tables Classification (manhattan)... \n";
						dl = cls.classificationTable("manhattan"); 
						cout 	<< "End of Tables Classification. \n";
						break;
...
void menu(string cl) {
	...
	//MENU CLASS CLASSIFICATION
		...
		cout << endl << "\n ====================-CLASSIFICATION MENU-======================== \n";
		cout << "\n PLEASE CHOOSE AN OPTION \n";
		cout << "1.  CLASSIFICATION (EUCLIDEAN) \n";
		cout << "2.  CLASSIFICATION (MANHATTAN) \n";
		cout << "3.  ACCURACY \n";
		cout << "4.  PRINT TABLES \n";
		cout << "0.  RETURN TO MAIN MENU ";
		cout << endl << "\n ================================================================ \n";
